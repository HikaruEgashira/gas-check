...
gas-check evaluates the security, compliance, and best-practice posture of Google Apps Script projects through 13 domain-specific controls. It checks sharing settings, OAuth scopes, deployment hygiene, and more.
...
gas-check includes 13 GAS-specific controls:
